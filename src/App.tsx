...
const initialMissingData = [
  ...
  { id: 'kor', name: 'Coreia do Sul 🇰🇷', stickers: [2, 4, 6, 8, 13, 20] },
  {
    id: 'cze',
    name: 'Tchéquia 🇨🇿',
    stickers: [1, 2, 7, 8, 11, 12, 13, 14, 16, 20],
  },
  ...
  { id: 'cuw', name: 'Curaçao 🇨🇼', stickers: [4, 8, 12, 13, 17] },
  {
    ...
    stickers: [1, 2, 4, 5, 6, 11, 14, 16, 17, 20],
  },
  ...
  { id: 'bel', name: 'Bélgica 🇧🇪', stickers: [1, 5, 7, 10] },
  {
    id: 'egy',
    name: 'Egito 🇪🇬',
    stickers: [1, 3, 4, 5, 7, 8, 9, 10, 12, 15, 17],
  },
  {
    id: 'irn',
    name: 'Irã 🇮🇷',
    stickers: [4, 5, 6, 7, 8, 9, 10, 12, 15, 17, 19, 20],
  },
  ...
  { id: 'sen', name: 'Senegal 🇸🇳', stickers: [1, 7, 19] },
  {
    id: 'irq',
    name: 'Iraque 🇮🇶',
    stickers: [3, 4, 5, 6, 7, 9, 10, 11, 12, 14, 15, 16, 17, 18],
  },
  {
    id: 'nor',
    name: 'Noruega 🇳🇴',
    stickers: [1, 3, 5, 8, 11, 12, 13, 14, 16, 17, 19],
  },
  { id: 'por', name: 'Portugal 🇵🇹', stickers: [6, 7, 11, 14, 15, 16, 19, 20] },
  {
    id: 'cod',
    name: 'RD Congo 🇨🇩',
    stickers: [1, 2, 3, 5, 8, 11, 15, 16, 17, 18],
  },
  {
    id: 'uzb',
    name: 'Uzbequistão 🇺🇿',
    stickers: [1, 6, 7, 8, 9, 14, 15, 16, 20],
  },
  {
    id: 'col',
    name: 'Colômbia 🇨🇴',
    stickers: [1, 2, 3, 5, 6, 8, 9, 11, 14, 15, 16, 18],
  },
  { id: 'can', name: 'Canadá 🇨🇦', stickers: [2, 6, 7, 13, 14, 17] },
  {
    id: 'bih',
    name: 'Bósnia e Herzegovina 🇧🇦',
    stickers: [1, 2, 4, 5, 7, 8, 12, 13, 15, 17, 18],
  },
  ...
  { id: 'sui', name: 'Suíça 🇨🇭', stickers: [4, 5, 6, 8, 13, 19] },
  {
    id: 'usa',
    name: 'Estados Unidos 🇺🇸',
    stickers: [1, 2, 3, 4, 6, 8, 10, 11, 13, 15, 16, 19, 20],
  },
  { id: 'par', name: 'Paraguai 🇵🇾', stickers: [2, 6, 7, 12, 13, 14, 17, 18] },
  {
    id: 'aus',
    name: 'Austrália 🇦🇺',
    stickers: [2, 3, 5, 6, 7, 10, 11, 13, 15, 18, 19],
  },
  {
    id: 'tur',
    name: 'Turquia 🇹🇷',
    stickers: [2, 3, 4, 5, 8, 9, 11, 13, 15, 18, 19, 20],
  },
  {
    id: 'ned',
    name: 'Holanda 🇳🇱',
    stickers: [1, 4, 5, 9, 10, 11, 14, 15, 17, 18],
  },
  { id: 'jpn', name: 'Japão 🇯🇵', stickers: [1, 2, 3, 13, 15, 16, 19, 20] },
  {
    id: 'swe',
    name: 'Suécia 🇸🇪',
    stickers: [3, 4, 5, 7, 8, 9, 11, 12, 13, 14, 18, 20],
  },
  ...
  { id: 'cpv', name: 'Cabo Verde 🇨🇻', stickers: [1, 9, 13, 14, 16] },
  {
    id: 'ksa',
    name: 'Arábia Saudita 🇸🇦',
    stickers: [1, 2, 9, 10, 11, 13, 15, 16, 18, 20],
  },
  { id: 'uru', name: 'Uruguai 🇺🇾', stickers: [3, 5, 7, 8, 9, 11, 17] },
  {
    id: 'arg',
    name: 'Argentina 🇦🇷',
    stickers: [1, 2, 3, 7, 8, 15, 17, 18, 20],
  },
  ...
  { id: 'cro', name: 'Croácia 🇭🇷', stickers: [9, 10, 11, 18] },
  {
    id: 'gha',
    name: 'Gana 🇬🇭',
    stickers: [1, 2, 3, 4, 5, 6, 7, 8, 10, 11, 12, 13, 15, 16, 17, 20],
  },
  {
    id: 'pan',
    name: 'Panamá 🇵🇦',
    stickers: [2, 3, 5, 8, 9, 10, 11, 13, 15, 16, 18, 19],
  },
];
